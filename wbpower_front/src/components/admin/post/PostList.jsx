...
const toggleStatus = async (id, currentStatus) => {
  ...
  try {
    await api.put(`/updatepoststatus/${id}`, { is_active: newStatus });
            ...
            <table className="min-w-full text-sm text-gray-700">
              <thead className="bg-gray-100 text-xs uppercase font-semibold text-gray-600">
                <tr>
                  ...
                  <th className="px-6 pb-3 pt-5 text-left">Image</th>
                  <th className="px-6 pb-3 pt-5 text-left">Title</th>
                  <th className="px-6 pb-3 pt-5 text-left">Body</th>
                  <th className="px-6 pb-3 pt-5 text-left">Category</th>
                ...
                {currentPosts.length === 0 ? (
                  ...
                  currentPosts.map((post, index) => (
                    ...
                    >
                      ...
                      <td className="px-4 py-2 table-data">{post.category_name}</td>
                     <td className="px-4 py-2 table-data">
                            <p
